...
# package
import road2qgis.toolbelt.log_handler as log_hdlr
from road2qgis.__about__ import __title__, __version__
...
class PlgSettingsStructure:
    ...
    service_url: str = "https://data-qua.geopf.fr/navigation"
    service_resource: str = "bdtopo_osrm"
