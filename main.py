...
class Road2QGIS:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Road2QGIS', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Calcul d\'itinéraires Géoplateforme'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = Road2QGISDialog(self.iface)
