...
# project
from road2qgis.__about__ import (
    __icon_path__,
    __title__,
    __uri_homepage__,
    __uri_tracker__,
...
from road2qgis.toolbelt import PlgLogger, PlgOptionsManager
from road2qgis.toolbelt.preferences import PlgSettingsStructure
...
class ConfigOptionsPage(FORM_CLASS, QgsOptionsPageWidget):
    ...
    def apply(self):
        ...
        # service
        settings.service_url = self.edit_url.text()
        settings.service_resource = self.edit_resource.text()
    ...
    def load_settings(self):
        ...
        # service
        self.edit_url.setText(settings.service_url)
        self.edit_resource.setText(settings.service_resource)
